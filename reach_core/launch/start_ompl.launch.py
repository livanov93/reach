...
def generate_launch_description():
    ...
    planning_pipeline_config["move_group"] = ompl_planning_pipeline_config
    ...
    joint_limits_yaml = {
        "robot_description_planning": load_yaml(
            "reach_demo",
            os.path.join("config", "moveit", "pilz_joint_limits.yaml"),
        )
    }
    cartesian_limits_yaml = {
        "robot_description_planning": load_yaml(
            "reach_demo",
            os.path.join("config", "moveit", "cartesian_limits.yaml"),
        )
    }
